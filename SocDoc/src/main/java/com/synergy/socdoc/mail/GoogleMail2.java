...
public class GoogleMail2 {
   public void sendmail(String recipient, String certificationCode) throws Exception{
          ...
          prop.put("mail.smtp.host", "socdocsocdoc@gmail.com");
          ...
          Authenticator smtpAuth = new MySMTPAuthenticator2();
          ...
          // 보내는 사람의 메일주소
          String sender = "socdocsocdoc@gmail.com";

...
$(document).ready(function() {
   ...
   <h3 style="margin-left: 4%; margin-bottom: 3%; margin-top: 6%; color:black;">예약하실정보확인</h3>
     ...
     SOCDOC 로그인 </a>
      ...
      <input type="hidden" name="hpName" id="hpName" value="">      
      </form>
   </div>
   <br>
   ...
   <div class="hpsinfo" style="float: left; width:150px; margin-left: 6px;">
      ...
      <c:if test="${empty hpinfovoList}">
         <tr style="padding: 50%; border: solid 1px red;">
            <td style="padding: 20%; padding-left: 20%;">
            등록 된 <br/>
            병원이 없습니다.</td>
         </tr>
      </c:if>
      ...
      <!-- 리뷰보기 --><a href='<%= ctxPath%>/socdoc/hospitalDetail.sd?hpSeq=${hpinfovoList.hpSeq}' target="_blank" style="color: blue; font-size: 9pt; font-weight: bold;">리뷰 및 상세보기</a><br/>
      <br/>
      <!-- 선택하기버튼 -->
     ...
     <a href="javascript:selecthospital('${hpinfovoList.hpName}','${hpinfovoList.dept}', '${hpinfovoList.hpSeq}')" name="selecthospital" id="selecthospital" class="click">선택</a>
      </div>
      <br/>
      </td>

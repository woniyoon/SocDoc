...
<body>
    <header>
        <img id="logo" src="/JqueryStudy/Final/logo.jpg" width=80px height=80px />
        <ul class="headerMenu">
            <li><a>찾기</a></li>
            <li><a>예약</a></li>
            <li><a>후기</a></li>
   ...
   <!-- 기본정보 변경 form끝 -->
    ...
    <!-- 비밀번호 변경탭 시작-->
		<div id="box2" style="margin-top:15px;  border-left: none; border-right: none;">
			<img id="findPW" src="/JqueryStudy/Final/findPW.png" style="margin-top:10px;" width=50px height=60px/>
			<h2 style="margin: 0;">비밀번호 변경</h2>
			<p style="margin-top: 10;">주혜정 회원님의 소중한 개인정보의 보호를 위하여 비밀번호를 한번 더 입력하여 주시기 바랍니다.</p>
		</div> 
	...
	<!-- 비밀번호 변경탭 끝-->
		...
		<div style="text-align:right; margin-top: 30px; width: 80%;"><button type="button" style="background-color: skyblue; color:white; width: 50px; height: 30px; border-radius: 4px; border: none; font-size: 10pt;">저장</button></div>
        </div>
    </main>
    <footer>
    </footer>
